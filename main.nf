...
/*
========================================================================================
                         nf-core/nf-large-assembly
========================================================================================
 nf-core/nf-large-assembly Analysis Pipeline.
 #### Homepage / Documentation
 https://github.com/nf-core/nf-large-assembly
----------------------------------------------------------------------------------------
*/
...
def helpMessage() {
    log.info"""
    =========================================
     nf-core/nf-large-assembly v${workflow.manifest.version}
    =========================================
    Usage:

    The typical command for running the pipeline is as follows:

    nextflow run nf-core/nf-large-assembly --reads '*_R{1,2}.fastq.gz' -profile standard,docker
...
======================================================="""
def summary = [:]
summary['Pipeline Name']  = 'nf-core/nf-large-assembly'
...
workflow.onComplete {
    ...
    def subject = "[nf-core/nf-large-assembly] Successful: $workflow.runName"
    if(!workflow.success){
      subject = "[nf-core/nf-large-assembly] FAILED: $workflow.runName"
    }
    def email_fields = [:]
    ...
    if (params.email) {
        try {
          ...
          log.info "[nf-core/nf-large-assembly] Sent summary e-mail to $params.email (sendmail)"
        } catch (all) {
          // Catch failures and try with plaintext
          [ 'mail', '-s', subject, params.email ].execute() << email_txt
          log.info "[nf-core/nf-large-assembly] Sent summary e-mail to $params.email (mail)"
        }
    }
    ...
    log.info "[nf-core/nf-large-assembly] Pipeline Complete"
